...
export default function PopularProducts() {
    ...
    return (
        <div className="mt-24">
            <div className="text-center flex flex-col items-center gap-2 lg:gap-4">
                <h2 className="text-[1.5rem] lg:text-[2rem] font-bold">
                    Popular products
                </h2>
                <p className="text-primary-purple">Our big names</p>
                <TabsArray tabs={tabs} activeTab={activeTab} setActiveTab={setActiveTab} />
            </div>
            {activeTab === 'Fashion' && <div className="mt-8 flex flex-col items-center  justify-center w-full">

                <div className="flex flex-wrap justify-center">
                    <ProductCard image={image1} details="Stripe shirt" price="₦5000" inStock={true} />
                ...
                <button className="bg-primary-orange text-[.8rem] lg:text-[1rem] text-primary-white rounded-3xl  w-fit mx-auto px-3 py-2 flex items-center gap-2 mt-8">View store <Icon icon="tabler:arrow-right" className="text-primary-orange bg-primary-white rounded-full" /></button>
            </div>}
            {activeTab === 'Groceries' && <div className="mt-8 flex flex-col items-center  justify-center w-full">
            ...
            {activeTab === 'Appliances' && <div className="mt-8 flex flex-col items-center  justify-center w-full">
            ...
            {activeTab === 'Sport' && <div className="mt-8 flex flex-col items-center  justify-center w-full">
                ...
                <button className="bg-primary-orange text-[.8rem] lg:text-[1rem] text-primary-white rounded-3xl  w-fit mx-auto py-2 px-3 flex items-center gap-2 mt-8">View store <Icon icon="tabler:arrow-right" className="text-primary-orange bg-primary-white rounded-full" /></button>
            </div>}
        </div>
    )
}