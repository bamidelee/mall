...
export default function ProductCard({ image, details, price, inStock, first }: Props) {
    ...
    return (
        <div className={`p-2 w-[45vw] lg:w-[20vw] h-[65vw] lg:h-fit relative border-2 border-secondary-grey flex flex-col lg:items-end justify-between lg:justify-center rounded-2xl transition-all duration-300`}>
            <div className="h-[30vw] lg:h-[11vw] w-full left-0 right-0 mx-auto bg-secondary-grey rounded-2xl p-2">
            ...
            <div className="absolute left-0 right-0 mx-auto top-[3rem] z-20 w-[40vw] lg:w-[15vw] h-[50%] lg:h-[50%] animate__animated animate__slideInUp">
